...
def test_gene_value_schema(gene_value_data):
...
def test_geneset_schema(geneset_data):
...
def test_geneset_upload_schema(geneset_upload_data):
...
def test_batch_upload_schema(batch_upload_data):
...
def test_group_schema(group_data):
...
def test_user_admin_group_schema(user_admin_group_data):
...
def test_project_schema(project_data):
...
def test_project_create_schema(project_create_data):
...
def test_publication_schema(publication_data):
...
def test_stubgenerator_schema(stub_generator_data):
